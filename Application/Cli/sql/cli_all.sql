...
CREATE TABLE `cli` (
  ...
  `company_name` varchar(90) NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=116 DEFAULT CHARSET=utf8 COMMENT='客户表';
...
INSERT INTO `cli` VALUES ('115', '123321', '123321', '3', '0', '0', '0', '23321', '123321', '1431094677', '0');
...
CREATE TABLE `cli_follow` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='沟通表';

-- ----------------------------
-- Records of cli_follow
-- ----------------------------
INSERT INTO `cli_follow` VALUES ('27', '110', '123', '0', '0', '12312321', '0');
INSERT INTO `cli_follow` VALUES ('28', '110', '123', '0', '0', '12312321', '0');
INSERT INTO `cli_follow` VALUES ('29', '110', '123', '1', '2', '213123', '0');
INSERT INTO `cli_follow` VALUES ('30', '114', '0', '1', '1', '阿斯蒂芬放大法按时阿斯顿发达啊啊地方阿斯蒂芬阿斯蒂芬阿凡达', '1');
...
CREATE TABLE `cli_link` (
  ...
  `insert_type` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=134 DEFAULT CHARSET=utf8 COMMENT='联系人信息';
