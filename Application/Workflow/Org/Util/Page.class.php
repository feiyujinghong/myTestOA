...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'条记录','prev'=>'上一页','next'=>'下一页','first'=>'首页','last'=>'尾页','theme'=>'<div class="pagination pull-right"><ul>%first%  %prePage%  %upPage%  %linkPage% %downPage%  %nextPage% %end%</ul></div>');
    // 默认分页变量名
    protected $varPage;
